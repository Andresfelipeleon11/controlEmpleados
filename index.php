        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="formLogin">
                    ...
                    <label for="numero_documento" class="form-label mb-3">Número de Documento:</label>
                        <input type="number" class="form-control" id="numero_documento" name="numero_documento" placeholder="Ingrese el numero de documento">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="text-center" id="divBotonIngresar">
                        <button type="button" id="btnIngresar" name="btnIngresar">Ingresar</button>  
                    </div>
                </form>
            </div>
        </div>
